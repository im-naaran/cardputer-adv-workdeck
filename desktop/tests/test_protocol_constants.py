...
from adv_helper.core.protocol_constants import (
    ...
    ACTION_ACTIONS_LIST, ACTION_SCRIPTS_EXECUTE, ACTION_SHORTCUT_EXECUTE, SCRIPT_PAGE_SIZE,
    ACTION_SYSTEM_HELLO,
...
def test_desktop_constants_match_shared_protocol_fixture():
    path = Path(__file__).parents[2] / "protocol" / "fixtures" / "protocol_constants.json"
    ...
    assert fixture["actionIds"] == [ACTION_SYSTEM_HELLO, ACTION_CODEX_USAGE_READ, ACTION_SYSTEM_TIME_READ, ACTION_ACTIONS_LIST, ACTION_SCRIPTS_EXECUTE, ACTION_SHORTCUT_EXECUTE]
    assert fixture["scriptPageSize"] == SCRIPT_PAGE_SIZE
